...
<head>
    ...
    <!-- Favicon -->
    <link href="img/pngtree-silhouette-image-of-a-man-vector-png-image_6993550.png" rel="icon">
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51" >
    ...
    <div class="right"><img src="img/149691609.png" alt=""></div>
       ...
       <div class="left"> 
        <h2>Semir Sultan</h2>
        <p class="s">Web Developer | Front-End & Back-End Specialist | UI/UX Enthusiast</p>
        ...
        <div class="row g-5 mb-5 align-items-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="col-lg-6 text-lg-end">
                <ul class="list-inline mx-n3 mb-0" id="portfolio-flters">
                    <li class="mx-3 active" data-filter="*" style="color:aliceblue">All Projects</li>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("SELECT * FROM contact WHERE name = ? AND email = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        if ($stmt->execute()) {
        ?><p style="color: green;"><?php echo "success"; ?></p><?php
        } else {
